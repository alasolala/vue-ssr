...
var routes = [{
  ...
  name: 'About',
  component: function component() {
    return __webpack_require__.e(/* import() */ 2).then(__webpack_require__.bind(null, 72));
  }
}];
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __webpack_require__(48)("follow-redirects");
    }
    catch (error) {
      debug = function () { /* */ };
    }
